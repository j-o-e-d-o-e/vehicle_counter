...
class VehicleCounter(object):
    ...
    def update_count(self, matches, k, output_image = None):
        ...
        if output_image is not None:
            ...
            print ("VEHICLE1:",self.vehicle_count1)
            print ("VEHICLE2:",self.vehicle_count2)
            print ("VEHICLE3:",self.vehicle_count3)
            print ("VEHICLE4:",self.vehicle_count4)
            print ("VEHICLE5:",self.vehicle_count5)
            print ("VEHICLE6:",self.vehicle_count6)
